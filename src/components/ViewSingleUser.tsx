...
function ViewSingleUser() {
  ...
  return (
    <JobpostContainer>
    <JobpostTitle>Viewing Account Info for User ID {usrAcc.user_id}</JobpostTitle>
    ...
    <JobpostButton onClick={() => {setAdminModal(true)}}>Make Admin</JobpostButton>
    ...
    {adminModal && <Modal setOpenModal={setAdminModal} BodySubject="This user will be granted HezaWorks admin roles"
    handleContinue={() => navigate(`/adminpanel/newadmin/${usrAcc.user_id}`)}/>}
    ...
    {deactivateModal && <Modal setOpenModal={setDeactivateModal} BodySubject="This user will be temporarily disabled"
