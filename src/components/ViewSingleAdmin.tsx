...
function ViewSingleRecruiter() {
  ...
  return (
    <JobpostContainer>
    <JobpostTitle>Viewing Account Info for Admin user ID {usrAcc.user_id}</JobpostTitle>
    ...
    {deactivateModal && <Modal setOpenModal={setDeactivateModal} BodySubject="This admin will be temporarily disabled"
