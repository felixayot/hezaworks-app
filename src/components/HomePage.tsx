...
function HomePage() {
  ...
  return (
    <>
      ...
      <HomeContainer>
        <HomeTitle>
          Join the biggest professional community at HezaWorks.
          <br />
          <span style={{ fontSize: "20px" }}>
            Find available jobs{" "}
            <HomeLink to="/jobs">
              <span style={{ color: "#27005D" }}>here</span>
            </HomeLink>
          </span>
        </HomeTitle>
        <HomeDescription>
          Find talent and get hired for your talent today
          <br />
          <br />
          <HomeButton onClick={() => navigate("/signup")}>
            {/*<HomeLink to="/signup">*/}Get started{/*</HomeLink>*/}
          </HomeButton>
        </HomeDescription>
      ...
      <HomeContainer>
        <div>
          <ItemTitle>
            <HomeIcon className="fa-solid fa-list" />
            Our Services
          </ItemTitle>
          <HomeDescription>
            Find talent and get hired for your talent today
            ...
            <br />
            <HomeButton>
              <HomeLink to="#">Learn more</HomeLink>
            </HomeButton>
          </HomeDescription>
        </div>
        <div>
          <ItemTitle>
            <HomeIcon className="fa-solid fa-gift" />
            Our Offers
          </ItemTitle>
          <HomeDescription>
            Find talent and get hired for your talent today
